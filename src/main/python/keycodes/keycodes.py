...
KEYCODES_MODIFIERS = [
    ...
    K("LSFT(kc)", "LSft\n(kc)", "Hold Left Shift while sending kc", masked=True),
    K("LCTL(kc)", "LCtl\n(kc)", "Hold Left Control while sending kc", masked=True),
    K("LALT(kc)", "LAlt\n(kc)", "Hold Left Alt while sending kc", masked=True),
    K("LGUI(kc)", "LGui\n(kc)", "Hold Left GUI while sending kc", masked=True),
    K("RSFT(kc)", "RSft\n(kc)", "Hold Right Shift while sending kc", masked=True),
    K("RCTL(kc)", "RCtl\n(kc)", "Hold Right Control while sending kc", masked=True),
    K("RALT(kc)", "RAlt\n(kc)", "Hold Right Alt (AltGr on German systems) while sending kc", masked=True),
    K("RGUI(kc)", "RGui\n(kc)", "Hold Right GUI while sending kc", masked=True),
